...
└── references/
    ...
    ├── language-patterns.md              # Языковые паттерны #10–15 + #15a–15d
...
Регулярные выражения для следов копирования из чат-ботов. Один такой маркер в обычном тексте — почти точно ИИ. Все выражения прогоняются автоматически: `python3 scripts/check_markers.py` — три уровня образцов на каждое, прогон обязателен в CI (19 из 19 проходят).
